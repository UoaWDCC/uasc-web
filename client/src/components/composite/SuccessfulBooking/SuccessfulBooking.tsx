  ...
  return (
    <div className="border-gray-3 flex h-auto w-full flex-col items-start rounded-md border-2 bg-white px-8 py-2">
      ...
      <div className="mb-2">
        <button
          type="button"
          className="text-dark-blue-100 border-dark-blue-100 hover:bg-dark-blue-100 rounded-md border bg-white p-2 text-sm font-bold hover:scale-105 hover:text-white"
        >
