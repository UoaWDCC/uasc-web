...
const AlertsComponent = ({ variant, message, isButton }: AlertsInputProp) => {
  ...
  const SuccessAlert = () => {
    return (
      <div className="bg-green flex h-12 w-full items-center md:justify-between rounded-lg">
  ...
  const ErrorAlert = () => {
    return (
      <div className="bg-red flex h-12 w-full items-center md:justify-between rounded-lg">
        <div className="ml-10 mr-5 h-5 w-5">
  ...
  const NotificationAlert = () => {
    return (
      <div className="bg-orange flex h-12 w-full items-center md:justify-between rounded-lg">
        <div className="ml-10 mr-5 h-5 w-5">
