...
export const DefaultEventsCard: Story = {
  ...
  args: {
    ...
    image:
      "https://drive.google.com/file/d/1z7njmdp2ItAbCvkA-l3uPkwFfZPeOrb7/view?usp=drive_link"
  }
}
  ...
  render: () => (
    <div style={{ display: "flex flex-col", gap: "1rem" }}>
      <EventsCard
        ...
        onClick={() => {}}
        image="https://drive.google.com/file/d/1z7njmdp2ItAbCvkA-l3uPkwFfZPeOrb7/view?usp=drive_link"
      />
      <EventsCard
        title="Another Event"
        date="FRI 19/7 • 7pm"
