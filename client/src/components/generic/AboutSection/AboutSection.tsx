  ...
  if (variant === "left") {
    return (
      <div className="relative left-0 w-[71%]">
        ...
        <div className=" absolute top-[100%] flex w-full flex-col overflow-hidden rounded-t-lg sm:rounded-b-lg border border-black bg-white md:left-[72%] md:top-[70%] md:h-[56%] md:w-[40%] lg:left-[35%] lg:top-[70%] lg:h-[56%] lg:w-[35%] lg:gap-4">
    ...
    return (
      <div className="relative left-[20%] w-[71%]">
        ...
        <div className=" absolute top-[100%] flex w-full flex-col overflow-hidden rounded-t-lg border sm:rounded-b-lg border-black bg-white md:left-[-25%] md:top-[60%] md:h-[45%] md:w-[74%] lg:left-[-19%] lg:top-[60%] lg:h-[45%] lg:w-[50%] lg:gap-4">
