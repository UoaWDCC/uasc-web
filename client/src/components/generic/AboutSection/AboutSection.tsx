  ...
  if (variant === "left") {
    return (
      <div className="relative left-0 w-[71%] border border-black">
        ...
        <div className=" absolute top-[100%] flex w-full flex-col overflow-hidden rounded-t-lg border border-black bg-white md:left-[72%] md:top-[70%] md:h-[56%] md:w-[52%] lg:left-[35%] lg:top-[70%] lg:h-[56%] lg:w-[40%] lg:gap-4">
    ...
    return (
      <div className="relative left-[20%] w-[71%] border border-black">
        ...
        <div className=" absolute top-[100%] flex w-full flex-col overflow-hidden rounded-t-lg border border-black bg-white md:left-[-25%] md:h-[45%] md:w-[74%] lg:left-[-19%] md:top-[60%] lg:top-[60%] lg:h-[45%] lg:w-[50%] lg:gap-4">
