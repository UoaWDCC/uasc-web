  ...
  if (variant === "left") {
    return (
      <div className="relative left-0 w-[71%]">
        ...
        ></img>
        <div className=" border-dark-blue-100 absolute top-[100%] flex w-[65%] flex-col overflow-hidden rounded-b-lg border bg-white md:left-[72%] md:top-[70%] md:h-[60%] md:w-[50%]  md:rounded-t-lg lg:left-[35%] lg:top-[70%] lg:h-[56%] lg:w-[35%] lg:gap-4  lg:rounded-t-lg">
          <TextStyler
            title={title}
            text={text}
            variant={"left"}
    ...
    return (
      <div className="relative left-[20%]">
        ...
        />
        <div className=" border-dark-blue-100 absolute top-[100%] flex w-[65%] flex-col overflow-hidden rounded-b-lg border bg-white sm:rounded-b-lg md:left-[-15%] md:top-[60%] md:h-[60%] md:w-[45%] md:rounded-t-lg lg:left-[-10%] lg:top-[60%] lg:h-[55%] lg:w-[30%] lg:gap-4 lg:rounded-t-lg">
          <TextStyler
            title={title}
            text={text}
            variant={"left"}
